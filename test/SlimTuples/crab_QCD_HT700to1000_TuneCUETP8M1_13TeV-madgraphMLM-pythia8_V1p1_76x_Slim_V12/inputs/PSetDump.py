...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/user/lcorcodi/BstarToTW_M-3000_RH_TuneCUETP8M1_13TeV-madgraph-pythia8/crab_BstarToTW_M-3000_RH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_76X_V2p1/160505_144638/0000/B2GEDMNtuple_4.root')
)
...
process.weights = cms.EDProducer("SlimUserData_weights",
...
process.p = cms.Path(process.weights+process.Filter+process.jetsAK8+process.jetsAK8jesup+process.jetsAK8jesdown+process.jetsAK8jerup+process.jetsAK8jerdown)
